...
If you are using [Puppeteer](/browser-rendering/platform/puppeteer/) in your Worker code, then you also need to add "nodejs_compat_v2" to the compatibility_flags in your Worker's `wrangler.toml` configuration. More information can be found in the [Node.js with Workers documentation](/workers/runtime-apis/nodejs/#enable-nodejs-with-workers) and the [Node.js with Pages Functions documentation](/workers/runtime-apis/nodejs/#enable-nodejs-with-pages-functions).
:::
